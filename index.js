...
*/
const sandwich = createMenuItem("sandwich", 100, "lunch");
const bagel = createMenuItem("bagel", 110, "breakfast");
const grilledcheese = createMenuItem("grilledcheese", 50, "breakfast");
